                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group ">
                                <input id="name" type="text" name="name" class="form-control bg-white" required  placeholder="Nhập tên của bạn">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input id="email" type="email" name="email" class="form-control bg-white" required placeholder="Nhập email">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <div class="input-group">
                                <input id="password" type="password" name="password" class="form-control bg-white" required placeholder="Nhập mật khẩu">
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <div class="input-group">
                                <input id="password_confirmation" type="password" name="password_confirmation" class="form-control bg-white" required placeholder="Nhập lại mật khẩu">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input id="address" type="text" name="address" class="form-control bg-white" required placeholder="Nhập địa chỉ">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input id="phone_number" type="text" name="phone_number" class="form-control bg-white" required pattern="[0-9]{10,11}" placeholder="Nhập số điện thoại">
                            </div>
                        </div>
